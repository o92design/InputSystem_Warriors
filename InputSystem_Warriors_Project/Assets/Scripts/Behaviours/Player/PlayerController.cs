...
public class PlayerController : MonoBehaviour
{
  ...
  [Header("Attributes")]
  public AttributesPlayer m_attributes;
  ...
  public void SetupPlayer(int newPlayerID)
  {
    ...
    m_attributes = GetComponent<AttributesPlayer>(); // TODO: Make this somewhere else
  }
  ...
  public void OnMovement(InputAction.CallbackContext value)
  {
    ...
    playerMovementBehaviour.movementSpeed = m_attributes.Physical.Speed.Skillpoints;
  }
